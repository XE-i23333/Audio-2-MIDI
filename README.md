...
- Download FFmpeg full-shared from the [FFmpeg builds page](https://www.gyan.dev/ffmpeg/builds/), copy the `bin` folder into the edition directory you want to run or build (`cpu/`, `cuda/`, or `directml/`), and rename it to `ffmpeg`.
