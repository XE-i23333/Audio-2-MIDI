...
class Converter(QWidget):
    ...
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Audio 2 MIDI v0.5.0 (DirectML)")
        ...
        self.translations = {
            "en": {
                ...
                "onset_hint": "Many soft notes are missed: decrease Onset\nToo many noise notes: increase Onset",
                "frame_hint": "Long notes are cut short: decrease Frame\nNote tails are too long: increase Frame",
